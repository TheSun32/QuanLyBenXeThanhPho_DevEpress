...
using System.Linq;
using QuanLyBenXeThanhPho_DevEpress.Blazor.Server.ORMDataModel;
...
{
    public static class ORMDataModelSystemTextJsonExtensions
    {
        public static IServiceCollection AddORMDataModelJsonOptions(this IServiceCollection builder)
        {
