...
namespace QuanLyBenXeThanhPho_DevEpress.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class QuanLyBenXeThanhPho_DevEpressModule : ModuleBase {
    public QuanLyBenXeThanhPho_DevEpressModule() {
		// 
		// QuanLyBenXeThanhPho_DevEpressModule
		// 
